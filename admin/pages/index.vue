      ...
      <div class="row">
        <div class="col-sm-8 col-8">
         ...
         <br>
          ...
          <a href="#" class="a-button-buy-again margin-right-10">Add a new product</a>
      ...
      <div class="container-fluid browsing-history">
        <div class="row">
          ...
          <div
            ...
            class="col-xs-2 col-lg-2 col-md-3 col-sm-6 col-6 br bb"
          >
            <div class="history-box">
              ...
              <div class="a-row">
                ...
                <span class="a-color-tertiary a-size-small asin-reviews">(1734)</span>
              </div>
              <!-- Product Price -->
              <div class="a-row">
              ...
              <!-- Product Buttons: Update and Delete -->
              <div class="a-row">
